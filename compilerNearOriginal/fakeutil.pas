...
function lib$get_foreign (var line1: descriptor; prompt: descriptor; var length1: integer): integer; nonpascal;
procedure sys$exit (i: integer); nonpascal;
procedure getcmdline (var line: cmdbuffer; var length: cmdindex); external;
