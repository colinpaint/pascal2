{ csi.pas - Command String Interpreter, parses the command string and sets the initial state of the switches }
{<<<}
...
var
  { The following file declarations must be included in each pass, must be first variables declared in that pass }
...
procedure gmcr; external; { Get command line for RSX }
{<<<}
procedure getcmdline (var line: cmdbuffer; {resulting command line}
                      var length: cmdindex {resulting command length} ); external;
{>>>}
{<<<}
...
function hdwropt: integer; external;
{>>>}
{<<<}
...
var
  ...
  temp_unixtarget: unixflavors; {Temporary holder for the global unixtarget.
                                 On small compilers unixtarget may be a constant.}
...
{>>>}
function skypilot: shortint; external;
