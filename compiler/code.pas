...
procedure gendouble(i: insttype; {instruction to generate} src, dst: keyindex {operand descriptors} ); forward;
...
procedure fpgendouble(i: insttype; {instruction to generate} src, dst: keyindex {operand descriptors}); forward;
